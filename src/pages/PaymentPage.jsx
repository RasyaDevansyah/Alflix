...
const PaymentPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0c1022] text-white">
      <Navbar />
      <div className="flex justify-center items-center min-h-screen px-4 py-10"> {/* ✅ responsive padding */}
        <div className="w-full max-w-md sm:max-w-lg md:max-w-xl bg-[#15172b] p-6 sm:p-8 rounded-lg shadow-lg"> {/* ✅ responsive width */}
          ...
          <form onSubmit={handleSubmit}>
            ...
            {selectedMethod === "credit" && (
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-3"> {/* ✅ flex responsive wrap */}
